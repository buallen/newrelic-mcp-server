...
async function investigateUploadFailures() {
  ...
  try {
    ...
    console.log(`• FTP/Upload logs: ${ftpResult.results.length > 0 ? '⚠️ FOUND ISSUES' : '❌ MISSING'}`);
    console.log(`• Network errors: ${networkResult.results.length > 0 ? '❌ ERRORS FOUND' : '✅ CLEAN'}`);
