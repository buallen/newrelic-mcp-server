        ...
        try {
            ...
            fs.writeFileSync(fileName, JSON.stringify({
                ...
                analysis: {
                    ...
                    storeIdMatches: results.filter(r => r.message?.includes('656095462daff80007eff192')).length,
                    transactionApiErrors: results.filter(r => r.message?.includes('transactionsIncludeOnline')).length
                }
            }, null, 2));
